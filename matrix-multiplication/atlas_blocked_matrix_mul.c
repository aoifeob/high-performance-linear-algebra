...
//        printf("Memory allocation required for each matrix is %lu bytes.\n\n", matrixMemorySize);
    ...
    for (int j = 0; j < iterations; j++) {
        gettimeofday(&tv1, &tz);
//        ATL_dgemm(CblasNoTrans, CblasNoTrans, matrixDimension, matrixDimension, matrixDimension, 1.0,
//                  firstMatrix, matrixDimension, secondMatrix, matrixDimension, 1.0, resultMatrix, matrixDimension);
        ATL_dgemm(CblasNoTrans, CblasNoTrans, matrixDimension, matrixDimension, matrixDimension, 1.0,
                  testFirstMatrix, matrixDimension, testSecondMatrix, matrixDimension, 1.0, resultMatrix, matrixDimension);
        gettimeofday(&tv2, &tz);
